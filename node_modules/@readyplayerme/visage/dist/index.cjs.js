...
const useGltfCachedLoader = (source) => {
    const cachedGltf = React.useRef(new Map());
    return suspendReact.suspend(() => __awaiter(void 0, void 0, void 0, function* () {
...
const BaseCanvas = ({ enablePostProcessing, children = undefined, fov = 50, position = new three.Vector3(0, 0, 5), style, dpr = [BASE_DPR * 0.5, 2], className }) => (React__default["default"].createElement(fiber.Canvas, { key: fov, className: `${styles$1['base-canvas']} ${className !== null && className !== void 0 ? className : ''}`, shadows: "soft", gl: {
...
const Avatar = ({ modelSrc, animationSrc = undefined, animations = undefined, activeAnimation = undefined, poseSrc = undefined, environment = 'soft', halfBody = false, shadows = false, scale = 1, cameraTarget = CAMERA.TARGET.FULL_BODY.MALE, cameraInitialDistance = CAMERA.INITIAL_DISTANCE.FULL_BODY, style, emotion, idleRotation = false, capture, background, onLoaded, onLoading, dpr, className, headMovement = false, cameraZoomTarget = CAMERA.CONTROLS.FULL_BODY.ZOOM_TARGET, onLoadedEffect, onLoadedAnimation, children, effects, keyLightIntensity, keyLightColor, fillLightIntensity, fillLightColor, fillLightPosition, backLightIntensity, backLightColor, backLightPosition, lightTarget, fov = 50, animationConfig, materialConfig }) => {
    ...
    const AvatarModel = React.useMemo(() => {
        ...
        if (!!activeAnimation && !halfBody && animations) {
            return (React__default["default"].createElement(MultipleAnimationModelContainer, { emotion: emotion, modelSrc: modelSrc, animations: animations, activeAnimation: activeAnimation, scale: scale, onLoaded: onLoaded, bloom: effects === null || effects === void 0 ? void 0 : effects.bloom, animationConfig: animationConfig, materialConfig: materialConfig }));
        }
    ...
    return (React__default["default"].createElement(BaseCanvas, { enablePostProcessing: enablePostProcessing, position: new three.Vector3(0, 0, 3), fov: fov, style: style, dpr: dpr, className: className },
        ...
        enablePostProcessing && (React__default["default"].createElement(postprocessing.EffectComposer, { autoClear: true, multisampling: 4, enableNormalPass: effects === null || effects === void 0 ? void 0 : effects.ambientOcclusion },
            React__default["default"].createElement(React__default["default"].Fragment, null,
                ...
                React__default["default"].createElement(postprocessing.BrightnessContrast, { brightness: 0.025, contrast: 0.25 }),
                React__default["default"].createElement(postprocessing.HueSaturation, { hue: 0, saturation: -0.2 })))),
